...
int ipv6_addr_add(const struct in6_addr *addr, uint8_t prefix_len, int state,
                  uint32_t valid_lifetime, uint32_t preferred_lifetime, uint32_t flags);
...
void handle_sctp(uint32_t src_ip, uint32_t dst_ip, const uint8_t *payload, uint16_t len);

/* IPv6 send helpers */
void send_ipv6(const struct in6_addr *dst, uint8_t next_hdr, const void *payload, uint16_t len);
void send_ipv6_flow(const struct in6_addr *dst, uint8_t next_hdr, const void *payload, uint16_t len,
                    uint32_t flow_label);
...
uint32_t ipv6_flow_label_calc(const struct in6_addr *src, const struct in6_addr *dst,
                              uint16_t src_port, uint16_t dst_port, uint8_t protocol);

/* IPv6 internal helpers (ipv6_core.c) */
int ipv6_parse_exthdr(const uint8_t *data, uint16_t total_len, uint8_t *out_proto,
...
void send_ipv6_fragmented(const struct in6_addr *dst, uint8_t next_hdr, const void *payload,
                          uint16_t len, uint32_t identification, uint16_t effective_mtu);
...
void send_ipv6_atomic(const struct in6_addr *dst, uint8_t next_hdr, const void *payload,
                      uint16_t len, uint32_t identification);
...
uint16_t ipv6_checksum(const struct in6_addr *src, const struct in6_addr *dst, uint8_t next_hdr,
...
int ipv6_nd_send_na(const struct in6_addr *target, const struct in6_addr *dst, int solicited,
                    int override, const struct in6_addr *src_override);
int ipv6_nd_send_rs(void);
int ipv6_nd_send_ra(const struct in6_addr *dst);
void ipv6_nd_handle_ns(struct ipv6_header *ip6, const uint8_t *payload, uint16_t len);
void ipv6_nd_handle_na(struct ipv6_header *ip6, const uint8_t *payload, uint16_t len);
void ipv6_nd_handle_rs(struct ipv6_header *ip6, const uint8_t *payload, uint16_t len);
void ipv6_nd_handle_ra(struct ipv6_header *ip6, const uint8_t *payload, uint16_t len);
...
void ipv6_mld_handle_query(struct ipv6_header *ip6, const uint8_t *payload, uint16_t len);
void ipv6_mld_handle_report_v1(struct ipv6_header *ip6, const uint8_t *payload, uint16_t len);
void ipv6_mld_handle_report_v2(struct ipv6_header *ip6, const uint8_t *payload, uint16_t len);
...
void ipv6_send_pmtu(const struct in6_addr *src, const struct in6_addr *dst,
                    const struct ipv6_header *offending, uint16_t offending_len,
...
void send_udp_ipv6(const struct in6_addr *dst, uint16_t src_port, uint16_t dst_port,
                   const void *data, uint16_t data_len);
void handle_udp_ipv6(struct ipv6_header *ip6, uint8_t *payload, uint16_t len);

/* TCP over IPv6 (tcp_ipv6.c) */
void tcp_ipv6_init(void);
void tcp_ipv6_compute_flow_label(struct tcp_conn *conn, const struct in6_addr *src_addr,
                                 const struct in6_addr *dst_addr);
void send_tcp_ipv6(struct tcp_conn *conn, const struct in6_addr *dst_addr, uint8_t flags,
                   const void *data, uint16_t data_len);
void handle_tcp_ipv6(struct ipv6_header *ip6, const uint8_t *payload, uint16_t len);
