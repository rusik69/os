...
#define SYS_NAME_TO_HANDLE_AT \
    379                           /* name_to_handle_at(dirfd, pathname, handle, mount_id, flags) \
                                   */
...
#define PR_SET_KEEPCAPS 8         /* set keep capabilities flag (0/1) */
...
#define PR_SET_CHILD_SUBREAPER 36 /* PR_SET_CHILD_SUBREAPER(arg2): make/clear a child subreaper */
#define PR_GET_CHILD_SUBREAPER 37 /* PR_GET_CHILD_SUBREAPER(arg2=&int): read subreaper status */
...
#define __NR_process_vm_writev \
    311                        /* process_vm_writev(pid, liov, liovcnt, riov, riovcnt, flags) \
                                */
...
#define __NR_kexec_file_load \
    320                   /* kexec_file_load(kernel_fd, initrd_fd, cmdline_len, cmdline, flags) */
