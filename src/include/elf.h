...
#define R_X86_64_GOTOFF64 25   /* S + A - GOT (offset from GOT base) */
#define R_X86_64_GOTPC32 26    /* GOT + A - P (GOT base 32-bit PC-relative) */
#define R_X86_64_GOT64 27      /* G + A (GOT entry 64-bit address) */
#define R_X86_64_GOTPCREL64 28 /* G + GOT + A - P (GOT PC-relative 64-bit) */
#define R_X86_64_GOTPC64 29    /* GOT + A - P (GOT base PC-relative, large model) */
#define R_X86_64_GOTPLT64 30   /* G + A (GOT/PLT entry 64-bit) */
#define R_X86_64_PLTOFF64 31   /* L + A - GOT (PLT entry offset from GOT base) */
