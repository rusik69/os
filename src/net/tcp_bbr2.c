...
/* ── Implement: tcp_bbr2_cong_avoid ────────────────── */
int tcp_bbr2_cong_avoid(void *sk) { (void)sk; return 0; }
/* ── Implement: tcp_bbr2_ssthresh ────────────────── */
uint32_t tcp_bbr2_ssthresh(void *sk) { (void)sk; return 2; }
