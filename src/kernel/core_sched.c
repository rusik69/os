...
static int sched_core_task_online(struct process *task, int cpu)
{
    (void)task;
    (void)cpu;
...
static int sched_core_task_offline(struct process *task, int cpu)
{
    (void)task;
    (void)cpu;
...
static void sched_core_free(struct process *task)
{
    (void)task;
